...
/**
 * Allowlist (whitelist) DNS rule manager.
 *
 * An allowlist hit bypasses this app's block rules, but the query still goes
 * through the selected encrypted DNS upstream for resolution.
 */
