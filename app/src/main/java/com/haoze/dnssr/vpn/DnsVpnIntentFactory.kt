...
object DnsVpnIntentFactory {
    ...
    const val ACTION_STOP = "com.haoze.dnssr.STOP_VPN"
    const val ACTION_REFRESH_APP_EXCLUSIONS = "com.haoze.dnssr.REFRESH_APP_EXCLUSIONS"
    const val ACTION_REFRESH_APP_ALLOWLIST = "com.haoze.dnssr.REFRESH_APP_ALLOWLIST"
    const val ACTION_REFRESH_RUNTIME_CONFIG = "com.haoze.dnssr.REFRESH_RUNTIME_CONFIG"
    const val ACTION_REFRESH_NOTIFICATION = "com.haoze.dnssr.notification.REFRESH_NOTIFICATION"
    const val ACTION_REFRESH_FLOATING_LOG = "com.haoze.dnssr.REFRESH_FLOATING_LOG"
    const val ACTION_FLOATING_LOG_APP_STATE = "com.haoze.dnssr.FLOATING_LOG_APP_STATE"
    const val ACTION_SYNC_RULE = "com.haoze.dnssr.SYNC_RULE"
    const val ACTION_REFRESH_RULE_INDEXES = "com.haoze.dnssr.REFRESH_RULE_INDEXES"
    const val ACTION_SYNC_HTTPS_REQUEST_RULES = "com.haoze.dnssr.SYNC_HTTPS_REQUEST_RULES"
