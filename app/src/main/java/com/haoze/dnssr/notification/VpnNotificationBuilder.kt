...
/**
 * Builds the VPN foreground service notification (running status, outbound
 * proxy status, and live transfer speed).
 */
object VpnNotificationBuilder {
    ...
    /**
     * Formats the live transfer speed text.
     */
