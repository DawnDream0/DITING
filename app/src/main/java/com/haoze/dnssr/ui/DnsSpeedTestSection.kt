...
/**
 * DNS speed test section of network diagnostics: sends real queries to the
 * selected providers and compares resolution latencies.
 * Settings such as provider selection and the test domain stay consistent
...
/**
     * Speed test results list: providers ranked by position; the fastest gets
     * a "fastest" badge and a latency bar scaled to the longest time.
     */
@Composable
