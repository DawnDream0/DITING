...
/**
 * Unified network diagnostics module: DNS speed test, ping test, DNS lookup,
 * and traceroute in one place.
 * A fixed network overview card and tool-switch tabs sit at the top; the four
 * tools live in horizontally swipeable pages.
 */
...
/**
 * Current network overview card: collapsed, it shows only the network type,
 * interface, and address summary; expanded, it lists IPv4 / IPv6 / gateway /
 * DNS item by item in monospace with tap-to-copy.
 */
@Composable
